# -*- coding: utf-8 -*-
"""
Created on Tue Aug 16 18:29:20 2022
...
def writeTiff(im_data, im_geotrans, im_proj, path):
    ...
    del dataset
def Augmentdata(train_image_path,train_label_path):
    #  进行几何变换数据增强
